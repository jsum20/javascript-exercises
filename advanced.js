 ...
 */
unitedKingdom[1]["toursitAttractions"] = ["Stonehenge","Chester Zoo"];
...
englandPopulation = unitedKingdom[1].population;
walesPopulation = unitedKingdom[2].population;
northerIrelandPopulation = unitedKingdom[3].population;

if ((scotlandPopulation < englandPopulation) && (scotlandPopulation < walesPopulation) && (scotlandPopulation < northerIrelandPopulation)) {
    console.log("The population of Scotland is the smallest");
} else if ((scotlandPopulation > englandPopulation) && (scotlandPopulation > walesPopulation) &&  (scotlandPopulation > northerIrelandPopulation)) {
